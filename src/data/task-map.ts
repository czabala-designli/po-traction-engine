...
export const WEEKS = [
  {
    ...
    groups: [
      ...
      { name: 'Foundation & client accounts', tasks: [
        ...
        { id: 'w1-4a', label: "Repo created under client's own GitHub org (enables code transfer anytime)", day: 2, owner: 'TL', support: [] },
        { id: 'w1-workspace', label: 'Google Workspace set up for founder email (Outlook acceptable)', day: 2, owner: 'PO', support: ['TL', 'CLIENT'], critical: true },
        { id: 'w1-llc', label: 'Client business entity (LLC) confirmed — enables the DUNS number and a company Apple Developer account (we confirm it, we do not set it up)', day: 2, owner: 'PO', support: ['CLIENT'], critical: true, show: { mobile: true } },
        { id: 'w1-3a', label: 'DUNS number requested (required for Apple Developer account)', day: 2, owner: 'PO', support: ['CLIENT', 'TL'], critical: true, show: { mobile: true } },
        ...
        { id: 'w1-standby', label: "Client's standby list of orbit users collected and kept on hand (a list, not a single name)", day: 2, owner: 'PO', support: ['CLIENT'] },
        { id: 'w1-3', label: 'Apple Developer account process started', day: 3, owner: 'PO', support: ['CLIENT', 'TL'], critical: true, show: { mobile: true } },
        { id: 'w1-3b', label: 'Google Play Console account process started', day: 3, owner: 'PO', support: ['CLIENT', 'TL'], critical: true, show: { mobile: true } },
        { id: 'w1-stores', label: 'Store apps and CI/CD pipelines set up', day: 4, owner: 'TL', support: ['DEV'], show: { mobile: true } },
      ...
      { name: 'PostHog · waitlist', tasks: [
        ...
        { id: 'w1-6', label: 'Internal cohort created (PO, Dev, TL)', day: 2, owner: 'PO', support: [] },
        { id: 'w1-7', label: 'Customer cohort created (founder & stakeholders)', day: 3, owner: 'PO', support: [] },
        { id: 'w1-8', label: 'Dynamic cohort configured for all other signups', day: 3, owner: 'PO', support: [] },
        { id: 'w1-9', label: 'PostHog email channels configured (domain/DNS)', day: 4, owner: 'PO', support: ['TL'] },
      ] },
      { name: 'PostHog · product', tasks: [
        { id: 'w1-sdk', label: 'PostHog SDK installed in the product app (captures out-of-the-box events)', day: 4, owner: 'DEV', support: ['PO'] },
      ] },
      { name: 'Landing page & emails', tasks: [
        { id: 'w1-10', label: 'Value proposition written & approved', day: 3, owner: 'PO', support: ['CLIENT'] },
        { id: 'w1-icp', label: 'ICP research completed (once discovery context is sufficient)', day: 4, owner: 'PO', support: [] },
        ...
        { id: 'w1-13', label: 'Feedback widget integrated, routing to GitHub Issues', day: 5, owner: 'PO', support: [] },
        { id: 'w1-14', label: 'Slack notification for new feedback configured', day: 5, owner: 'PO', support: [] },
  ...
  },
  {
    ...
    groups: [
      ...
      { name: 'Users', tasks: [
        ...
        { id: 'w2-8', label: 'Drip campaign running for all waitlist signups', day: 9, owner: 'PO', support: [] },
      ] },
      { name: 'Launch', tasks: [
