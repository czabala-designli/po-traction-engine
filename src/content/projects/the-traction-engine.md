...
checklistNote: "A curated set of milestone-level markers for this project, not the full day-by-day task map. For the complete kickoff list, see the Task Map Generator (count varies by entry path and injection; up to 69 tasks for a from-scratch mobile build) or the new-project template."
